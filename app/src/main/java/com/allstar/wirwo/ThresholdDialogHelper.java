...
public class ThresholdDialogHelper {
    ...
    public static void showSoilTempThresholdDialog(Context context, TextView threshold, View.OnClickListener okClickListener, View.OnClickListener cancelClickListener) {
        ...
        dialogTitle.setText("Set Soil Threshold Threshold");
